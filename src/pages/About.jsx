...
export default function About() {
  ...
  return (
    <div className='min-h-screen flex flex-col bg-gradient-to-b from-white to-gray-100 dark:from-[#0B061A] dark:to-[#120C24] text-center md:text-left'>
      <div className='flex flex-col text-center pt-6 '>
        <p className=' dark:text-white'>Get to Know more</p>
        <h1 className='text-4xl px-12  md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-pink-500 via-orange-500 to-blue-500 bg-clip-text text-transparent'>About Me</h1>
      </div>
      <div className='py-6 sm:grid sm:grid-cols-3 gap-4'>
